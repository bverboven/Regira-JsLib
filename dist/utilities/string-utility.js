...
function n(u) {
  return (
    ...
    /^(0?[1-9]|1[1,2])[\/\. -](0?[1-9]|[12][0-9]|3[01])[\/\. -](19|20)?\d{2}$/gi.test(u) || // computer format (YYYY-MM-DD)
    /^(19|20)\d{2}[\/\. -](0[1-9]|1[1,2])[\/\. -](0[1-9]|[12][0-9]|3[01])$/gi.test(u)
  );
}
function $(u) {
...
function O(u) {
  return u.replace(/[\u00A0-\u9999<>&]/gim, (e) => "&#" + e.charCodeAt(0) + ";");
}
function P(u) {
